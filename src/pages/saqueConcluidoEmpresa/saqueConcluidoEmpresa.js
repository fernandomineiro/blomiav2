...
class SaqueConcluido extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    async buscaSaldo() {
        await api.get(`/simple_balance?company_id=${this.props.client.company.id}`)
            .then(async response => {
        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    ...
                    />
                    <Text style={styles.textWithDrawComplete}>Saque realizado com sucesso!</Text>
                ...
                <View>
                    <ButtonCustom ação={() => this.props.navigation.navigate("inicioEmpresa")} btnColor={'#007f0b'} textColor={'#ffffff'} textButton={'INÍCIO'} />
                </View>
                <View>
...
export default connect(mapStateToProps)(SaqueConcluido);