      ...
      <View style={styles.slide1}>
        ...
        <View style={styles.content}>
          <Text style={styles.instructions}>
            Como você é novo(a) por aqui, preparamos algumas dicas para te
            ajudar.
          </Text>
          ...
          <Text style={styles.instructions2}>
            Mas antes, vou te contar sobre o app:
          </Text>
          <Text style={styles.instructions3}>
            O Blomia dá às pessoas capacidade de sacar e depositar seu dinheiro
            em segundos, em qualquer lugar e com segurança.
          </Text>
